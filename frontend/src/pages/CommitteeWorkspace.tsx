...
import { CalendarPlus, Crown, Eye, FileText, ListPlus, MessageSquare, QrCode, ShieldCheck, Trash2, Upload, UserPlus, Video } from "lucide-react";
            ...
            {["All", "Open", "In Progress", "Pending Verification", "Overdue", "Completed"].map((s) => (
              <button
                ...
                className={`rounded-full px-3 py-1.5 text-xs font-medium ${
                  statusFilter === s ? "bg-brand-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200 dark:hover:bg-slate-800/50"
                }`}
              >
                {s}
              </button>
